...
SOURCE = "http://192.168.93.202:4747/video"
FRAME_SIZE = (640, 480)
TRACKER_TYPE = "MOSSE"
...
def main():
    ...
    while True:
        ...
        if not deteccion_completada:
            ...
            mask = cv2.bitwise_or(mask_verde, mask_morado)
        ...
        if deteccion_completada and tracker is not None:
            ...
            if ok_tracker:
                ...
                hay_morado = cv2.countNonZero(cv2.inRange(hsv, morado_lower, morado_upper)) > 50

                if hay_morado and not hay_verde and not click_estado:
                    pyautogui.click()
                    estado_text = "CLICK"
                    click_estado = True
                elif hay_morado and hay_verde:
                    estado_text = "MOVIENDO"
                    click_estado = False
                elif not hay_morado:
                    estado_text = "BUSCANDO MANO"
