...
def main():
    subprocess.Popen(["python", "buscaminas.py"]) #Cargar buscaminas
    ...
    while True:
        ...
        mask = cv2.morphologyEx(mask_azul, cv2.MORPH_OPEN, kernel)
        ...
        if contours:
            ...
            if cv2.contourArea(c) > 200:
                ...
                # ESTADOS
                hay_verde = cv2.countNonZero(mask_verde) > 50
                hay_azul = cv2.countNonZero(mask_azul) > 50
            ...
            estado_text = "SIN DETECCION"

        dibujar_zona(frame, H_w2i)
        cv2.putText(frame, estado_text, (20,40),
